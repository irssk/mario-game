function Mario() {
  ...
  this.checkMarioType = function() {
    if (that.type == 'big') {
      ...
      // позиция большого спрайта Марио
      if (that.invulnerable) {
        that.sY = 276; // если неуязвим, покажи прозрачного Марио
      } else {
        that.sY = 90;
      }
      ...
      // маленький спрайт Марио
      if (that.invulnerable) {
        that.sY = 222; // если неуязвим, покажи прозрачного Марио
      } else {
        that.sY = 4;
      }
