function CreatedLevels() {
  ...
  this.startLevel = function(i) {
    ...
    var map = { 1: level }; // всегда только один уровень в сохраненных картах.
  ...
  this.removeCreatedLevelsScreen = function() {
    if (levelsWrapper) {
      ...
      while (levelsWrapper.hasChildNodes()) {
        // удаляет все созданные уровни с экрана, чтобы его можно было запустить снова, показывая новые уровни, созданные пользователем
